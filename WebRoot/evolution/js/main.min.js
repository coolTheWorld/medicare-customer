...
jQuery(function () {
	...
	setTheme = function (input_name, data_name) {
		$("input[name='" + input_name + "']").click(function () {
			...
			// 用localStorage存储内容
			window.localStorage.setItem('the_' + input_name, $(this).val())
			console.log('完成设置主题配色');
		});
	}
	...
	// 主题cookie保存--start
	// 读取Cookie
	var the_logo_bg =  window.localStorage.getItem('the_logo_bg'), 
		the_header_bg = window.localStorage.getItem('the_header_bg'),
		the_sidebar_bg = window.localStorage.getItem('the_sidebar_bg'), // iframe版本如果删除了下面一行，请把这一行的逗号改成分号
		the_site_theme = window.localStorage.getItem('the_site_theme'); // iframe版本可不需要这行
