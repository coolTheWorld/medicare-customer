...
<html>
	...
	<body>
		...
		<div data-options="region:'north',title:'高级查询'" style="height: 65px; background: #F4F4F4;">
			...
			<br/>
			<br/>
			<div class="easyui-panel" title="错误信息处理" data-options="border:true,fit:true" iconCls="icon-zc">
				<table id="allwronginfo" data-options="checkOnSelect:true,fit:true,singleSelect:true,rownumbers:true,pagination:true" cellpadding="2" cellspacing="1" toolbar="#toolbar">
					<thead>
						<tr>
							<th data-options="field:'sb',checkbox:true"></th>
							<th data-options="field:'cusDareway',align:'center',width:140">医院名称</th>
