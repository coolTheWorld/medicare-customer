						...
						<div class="card">
							...
							<div class="card-body">
								<table id="salesItems" title="销售记录"
									...
									<thead>
										<tr>
											<th field="soNo" width="80">医院编码</th>
											<th field="soSalespsnname" width="100">患者姓名</th>
											<th field="siPtssex" width="100">性别</th>
											<th field="siPtsage" width="80">年龄</th>
											<th field="siPtsidcard" width="80">身份证号</th>
											<th field="siPtshealthcard" width="80">医保卡号</th>
											<th field="drugCode" width="100">药品编码</th>
											<th field="drugName" width="110">药品名称</th>
											<th field="drugNum" width="80">销售数量</th>
											<th field="drugSalesprice" width="80">销售单价</th>
											<th field="drugSpecification" width="80">规格</th>
											<th field="drugBatchno" width="80">生产批号</th>
											<th field="drugMfrs" width="80">生产商</th>
											<th field="drugMadein" width="80">产地</th>
											<th field="drugMfgdate" width="80">生产日期</th>
											<th field="drugExpdate" width="80">有效期</th>
											<th field="drugEid" width="80">本位码(电子监管码)</th>
											<th field="soPaytype" width="80">结算方式编码</th>
											<th field="siSettlementname" width="80">结算方式名称</th>
											<th field="siStatus" width="80">结算状态</th>
											<th field="siOpcode" width="80">操作员编码</th>
											<th field="siOpname" width="80">操作员姓名</th>
											<th field="soDatetime" width="80">销售日(结算)期</th>
											<th field="siUnit" width="80">单位</th>
											<th field="siTracecode" width="80">追溯码</th>
											<th field="drugPicktime" width="80">采集时间</th>
											<th field="soCreatedatetime" width="80">创建日期</th>
