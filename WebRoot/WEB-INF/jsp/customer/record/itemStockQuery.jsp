								...
								<table id="itemStock" title="库存记录"
									...
									<thead>
										<tr>
											...
											<th field="itemCode" width="80">库存编号</th>
											<th field="itemName" width="80">库存名称</th>
											<th field="itemNum" width="100">库存数量</th>
											<th field="itemUnit" width="110">单位</th>
											<th field="itemSpecification" width="80">规格</th>
											<th field="itemBatchno" width="80">生产批号</th>
											<th field="itemPermission" width="80">批准文号</th>
											<th field="itemMfgdate" width="80">生产日期</th>
											<th field="itemExpdate" width="80">有效期</th>
											<th field="itemMfrs" width="80">生产商</th>
											<th field="itemMakein" width="80">产地</th>
											<th field="itemHcscode" width="80">本位码(医保编码)</th>
											<th field="itemWhcode" width="80">库房编码</th>
											<th field="itemWhname" width="80">库房名称</th>
											<th field="itemLocation" width="80">货位/货架号</th>
											<th field="itemPicktime" width="80">采集时间</th>
											<th field="itemAddtime" width="80">创建时间</th>
											<th field="itemChecknum" width="80">对比库存</th>	
										</tr>
									</thead>
								</table>
