								...
								<table id="discharged" title="出院记录"
									...
									<thead>
										<tr>
											...
											<th field="hospNo" width="100">住院号</th>
											...
											<th field="siPtsage" width="110">年龄</th>
											<th field="dcIndate" width="80">入院日期</th>
											<th field="dcOutdate" width="80">出院日期</th>
											<th field="dcHospdays" width="80">住院天数</th>
											<th field="dcOutype" width="80">出院方式</th>
											<th field="dcHosptimes" width="80">住院次数</th>
											<th field="dcDiagcode" width="80">出院诊断编码</th>
											<th field="dcDiagname" width="80">出院诊断名称</th>
											<th field="dcDoctorcode" width="80">医师编码</th>
											<th field="dcDoctorname" width="80">医师姓名</th>
											<th field="dcPickime" width="80">采集日期</th>
											<th field="dcAddtime" width="80">创建日期</th>
										</tr>
									</thead>
								</table>
