								...
								<table id="hospitalized" title="入院记录"
									...
									<thead>
										<tr>
											...
											<th field="doctorType" width="100">就医类别</th>
											<th field="caseNo" width="100">病案号</th>
											<th field="hospNo" width="80">住院号</th>
											<th field="diagType" width="80">接诊方式</th>
											<th field="diagDept" width="80">门诊科室编码</th>
											<th field="diagDeptname" width="100">门诊科室名称</th>
											<th field="diagDoctor" width="110">确诊医师编码</th>
											<th field="diagDoctorname" width="80">确认医师姓名</th>
											<th field="diagDatetime" width="80">确诊日期</th>
											<th field="icdCode" width="80">疾病编码</th>
											<th field="icdName" width="80">疾病名称</th>
											<th field="hospType" width="80">住院类别</th>
											<th field="hospWay" width="80">入院方式</th>
											<th field="hospDept" width="80">入院科室编码</th>
											<th field="hospDeptname" width="80">入院科室名称</th>
											<th field="hospDoctor" width="80">主冶医师编码</th>
											<th field="hospDoctorname" width="80">主冶医师姓名</th>
											<th field="hospAreas" width="80">病区名称</th>
											<th field="hospWardno" width="80">房间号</th>
											<th field="hospBedno" width="80">床位号</th>
											<th field="hospIntime" width="80">住院日期</th>
											<th field="siPtsname" width="80">患者姓名</th>
											<th field="siPtssex" width="80">性别</th>
											<th field="siPtsage" width="80">年龄</th>
											<th field="siPtsidcard" width="80">身份证号</th>
											<th field="siPtshealthcard" width="80">医保卡号</th>
											<th field="hospPicktime" width="80">采集日期</th>
											<th field="hospAddtime" width="80">创建日期</th>
										</tr>
									</thead>
								</table>
