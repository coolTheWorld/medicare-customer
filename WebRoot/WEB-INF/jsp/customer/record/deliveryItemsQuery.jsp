				...
				<ul class="topbar-right">
					<li class="dropdown dropdown-profile"><a
						href="javascript:void(0)" data-toggle="dropdown"> <img
							...
							src="${path}/customer/images/users/OIP.jpg" alt="管理员" /> <span>管理员
						...
						<div class="card">
							...
							<div class="card-body">
								<table id="deliveryItems" title="出库记录"
									...
									<thead>
										<tr>
											<th field="diNo" width="80">出库编号</th>
											<th field="diType" width="100">出库类别</th>
											<th field="diReason" width="100">出库原因描述</th>
											<th field="drugCode" width="80">药品编码</th>
											<th field="drugName" width="80">药品名称</th>
											<th field="drugNum" width="80">出库数量</th>
											<th field="diSpecification" width="100">规格</th>
											<th field="drugBatchno" width="110">生产批号</th>
											...
											<th field="diHcscode" width="80">本位码(医保编码)</th>
											<th field="diWhcode" width="80">库房编码</th>
											<th field="diWhname" width="80">库房名称</th>
											<th field="diLocation" width="80">货位/货架号</th>
											<th field="diOpcode" width="80">操作员编码</th>
											<th field="diOpname" width="80">操作员姓名</th>
											<th field="diOpdatetime" width="80">出库日期</th>
											<th field="diUnit" width="80">单位</th>
											<th field="diPicktime" width="80">采集日期</th>
											<th field="diAddtime" width="80">创建日期</th>
										</tr>
									</thead>
								</table>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#deliveryItems').datagrid({
				...
				/* url : "/customer/deliveryItemsData", */
