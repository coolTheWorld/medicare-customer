...
<meta charset="utf-8">
	...
	<title>门诊记录</title> <c:set value="${pageContext.request.contextPath}"
		var="path" scope="page" />
								...
								<table id="clinicrecords" title="门诊记录"
									...
									<thead>
										<tr>
											...
											<th field="diagNo" width="80">门诊编号</th>
											<th field="diagDatetime" width="80">门诊日期</th>
											<th field="diagDeptcode" width="100">科室编码</th>
											<th field="diagDeptname" width="110">科室名称 </th>
											<th field="diagDoctor" width="80">医师编码</th>
											<th field="diagDoctorname" width="80">医师姓名</th>
											<th field="diagDoctortime" width="80">诊断日期</th>
											...
											<th field="diagIcdcode" width="80">诊断代码</th>
											<th field="diagIcdname" width="80">诊断名称</th>
											<th field="regType" width="80">挂号类型</th>
											<th field="diagType" width="80">就诊方式</th>
											<th field="secType" width="80">险种类别</th>
											<th field="diagPaytype" width="80">医疗类别</th>
											<th field="diagPicktime" width="80">采集时间</th>
											<th field="diagAddtime" width="80">创建时间</th>
										</tr>
									</thead>
								</table>
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#clinicrecords').datagrid({
				...
				/* url : "/customer/clinicrecordsData", */
