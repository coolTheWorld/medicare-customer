		...
		<div class="lyear-layout-container">
			...
			<div class="container-fluid">
				...
				<div class="row">
								...
								<table id="wareHouseItem" title="入库记录"
									...
									<thead>
										<tr>
											...
											<th field="wiCode" width="80">入库编号</th>
											<th field="drugCollectdate" width="100">药品采集日期</th>
											<th field="wiDatetime" width="100">入库日期</th>
											<th field="wiType" width="80">入库类别</th>
											<th field="drugCode" width="80">药品编码</th>
											<th field="drugName" width="80">药品名称</th>
											<th field="drugNum" width="100">入库数量</th>
											<th field="drugPurchaseprice" width="110">采购价</th>
											...
											<th field="wiPrice" width="80">零售价</th>
											<th field="drugSpecification" width="80">规格</th>
											<th field="drugUnit" width="80">单位</th>
											<th field="drugHcscode" width="80">本位码(医保编码)</th>
											<th field="wiWhcode" width="80">库房编码</th>
											<th field="wiWhname" width="80">库房名称</th>
											<th field="wiLocation" width="80">货位/货架号</th>
					...
					<!-- </div><a href="javascript:void(0)" class="easyui-linkbutton" onclick="searchYesterday()">昨天</a>
									<a href="javascript:void(0)" class="easyui-linkbutton" onclick="searchBeforeYesterday()">前天</a>
								 -->
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$('#wareHouseItem').datagrid({
				...
				/* url : "/customer/wareHouseItemsData", */
