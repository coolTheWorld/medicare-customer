...
public final class ChineseCharToEn {
	...
	public static void main(String[] args) {
		String test = "我";
		test = new ChineseCharToEn().conversionStr(test, "UTF-8", "ISO8859-1");
		System.out.println(test);
		System.out.println(test.length());
		ChineseCharToEn cte = new ChineseCharToEn();
		System.out.println("获取拼音首字母：" + cte.getAllFirstLetter("北京联席办3aA"));//bjlxb3aA
		System.out.println(cte.getFirstLetter("我是中国人"));//w
	}
