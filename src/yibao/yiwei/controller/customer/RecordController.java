...
public class RecordController {
    ...
    public Map getWareHouseItemsData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = wareHouseItemFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Warehouseitem.class).result();
    ...
    public Map getDeliveryItemsData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = deliveryItemFactory.getRecord(request, date, date, page, rows,baseService, countSql, sql, Deliveryitem.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getSalesItemsData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = salesItemFactory.getRecord(request, date, date, page, rows,  baseService, countSql, sql, Salesitem.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getItemsStockData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = itemRecordFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Itemstock.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getPrescribeData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = prescribeFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Prescribe.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getClinicrecordsData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = clinicrecordFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Clinicrecords.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getHospitalizedData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = hospitalizedFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Hospitalized.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
    ...
    public Map getDischargedData(HttpServletRequest request, @RequestParam("page") String page,
        ...
        try {
            ...
            resultMap = dischargedFactory.getRecord(request, date, date, page, rows, baseService, countSql, sql, Discharged.class).result();
        } catch (BuildProcessException e) {
            logger.error(e.getMessage());
            e.printStackTrace();
        }
