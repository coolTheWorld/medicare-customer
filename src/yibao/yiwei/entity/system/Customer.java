...
public class Customer implements java.io.Serializable {
	...
	private String cusParentid;// 上级GUID，无或连锁总店为0
	...
	private int cusStatus;//状态：注销-1、待审核0、连锁分店2、其他1(包括连锁总店)
	private String cusRemark;// 备注8
	private String cusPcode;//客户拼音简码
	//private Double itemChecknum;

	//@Column(name = "ITEM_CHECKNUM", precision = 126, scale = 0)
	//public Double getItemChecknum() {
	//	return itemChecknum;
	//}
//
	//public void setItemChecknum(Double itemChecknum) {
	//	this.itemChecknum = itemChecknum;
	//}
