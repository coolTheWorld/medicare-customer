...
public class AllWrongInfo implements Serializable{
	...
	@Column(name="WRI_ID", unique=true, nullable=false, length=32)
	...
	@Column(name="WRI_CODE", length=32)
	...
	@Column(name="WRI_NAME", length=32)
	...
	@Column(name="WRI_STATUS", length=32)
	...
	@Column(name="WRI_ADDTIME", length=7)
	...
	@Column(name="CUS_ADDRESS", length=32)
