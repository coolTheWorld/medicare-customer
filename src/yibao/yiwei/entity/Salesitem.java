...
public class Salesitem implements java.io.Serializable {
	...
	private String siTracecode;//追溯码25
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss",timezone = "GMT+8")
	...
	@Column(name="SI_TRACECODE", length=32)
	public String getSiTracecode() {
		return siTracecode;
	}
	
	public void setSiTracecode(String siTracecode) {
		this.siTracecode = siTracecode;
	}
